...
import { FetchUserData, LocationChange } from "../Login/Loginaxios";
                        ...
                        open={openPopover}
                            content={
                                <div className="PopoverDiv">
                                    ...
                                    <button onClick={() => navigate('/orderhistory')} className="PopoverButton">Order history</button>
                                    <button onClick={() => {navigate('/login');localStorage.clear()}} className="PopoverButton">Logout </button>
                                </div>}
                            trigger="click"
                            placement="bottom"
                        >
                            <li onClick={()=>SetopenPopover(true)} className='listAlignment'>
